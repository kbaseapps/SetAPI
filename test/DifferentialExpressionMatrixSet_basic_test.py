...
class DifferentialExpressionMatrixSetAPITest(BaseTestClass):
    ...
    def prepare_data(cls: BaseTestClass) -> None:
        ...
        cls.diff_exps_no_genome = [
            make_fake_diff_exp_matrix(
                f"fake_mat_no_genome_{i}", cls.wsName, cls.wsClient
            )
            for i in range(3)
        ]
    ...
    def test_save_diff_exp_matrix_set(self):
        ...
        result = self.serviceImpl.save_differential_expression_matrix_set_v1(
            self.ctx,
            {
    ...
    def test_save_dem_set_mismatched_genomes(self):
        ...
        with pytest.raises(
            ...
            self.serviceImpl.save_differential_expression_matrix_set_v1(
                self.ctx,
                {
                    "workspace": self.wsName,
                    "output_object_name": set_name,
    ...
    def test_get_dem_set(self):
        ...
        dem_set_ref = self.serviceImpl.save_differential_expression_matrix_set_v1(
            self.ctx,
            {
                "workspace": self.wsName,
                "output_object_name": set_name,
        ...
        fetched_set = self.serviceImpl.get_differential_expression_matrix_set_v1(
        ...
        fetched_set_with_info = (
            self.serviceImpl.get_differential_expression_matrix_set_v1(
