...
public class ReadsSetItem {
    ...
    public ReadsSetItem withRefPath(java.lang.String refPath) {
        this.refPath = refPath;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((("ReadsSetItem"+" [ref=")+ ref)+", refPath=")+ refPath)+", label=")+ label)+", dataAttachments=")+ dataAttachments)+", info=")+ info)+", additionalProperties=")+ additionalProperties)+"]");
    }
