...
public class GetDifferentialExpressionMatrixSetV1Params {
    ...
    public java.lang.String toString() {
        return ((((((((("GetDifferentialExpressionMatrixSetV1Params"+" [ref=")+ ref)+", includeItemInfo=")+ includeItemInfo)+", refPathToSet=")+ refPathToSet)+", additionalProperties=")+ additionalProperties)+"]");
    }
