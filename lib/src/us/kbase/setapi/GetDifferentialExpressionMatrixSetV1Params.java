...
/**
 * <p>Original spec-file type: GetDifferentialExpressionMatrixSetV1Params</p>
 * <pre>
...
public class GetDifferentialExpressionMatrixSetV1Params {
    ...
    public GetDifferentialExpressionMatrixSetV1Params withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public GetDifferentialExpressionMatrixSetV1Params withIncludeItemInfo(Long includeItemInfo) {
        this.includeItemInfo = includeItemInfo;
        return this;
    }
    ...
    public GetDifferentialExpressionMatrixSetV1Params withIncludeSetItemRefPaths(Long includeSetItemRefPaths) {
        this.includeSetItemRefPaths = includeSetItemRefPaths;
        return this;
    }
    ...
    public GetDifferentialExpressionMatrixSetV1Params withRefPathToSet(List<String> refPathToSet) {
        this.refPathToSet = refPathToSet;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("GetDifferentialExpressionMatrixSetV1Params"+" [ref=")+ ref)+", includeItemInfo=")+ includeItemInfo)+", includeSetItemRefPaths=")+ includeSetItemRefPaths)+", refPathToSet=")+ refPathToSet)+", additionalProperties=")+ additionalProperties)+"]");
    }
