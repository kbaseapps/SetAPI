...
/**
 * <p>Original spec-file type: DifferentialExpressionMatrixSetItem</p>
 * <pre>
...
public class DifferentialExpressionMatrixSetItem {
    ...
    public DifferentialExpressionMatrixSetItem withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public DifferentialExpressionMatrixSetItem withRefPath(java.lang.String refPath) {
        this.refPath = refPath;
        return this;
    }
    ...
    public DifferentialExpressionMatrixSetItem withLabel(java.lang.String label) {
        this.label = label;
        return this;
    }
    ...
    public DifferentialExpressionMatrixSetItem withInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> info) {
        this.info = info;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("DifferentialExpressionMatrixSetItem"+" [ref=")+ ref)+", refPath=")+ refPath)+", label=")+ label)+", info=")+ info)+", additionalProperties=")+ additionalProperties)+"]");
    }
