...
public class GetExpressionSetV1Params {
    ...
    public GetExpressionSetV1Params withIncludeSetItemRefPaths(Long includeSetItemRefPaths) {
        this.includeSetItemRefPaths = includeSetItemRefPaths;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("GetExpressionSetV1Params"+" [ref=")+ ref)+", includeItemInfo=")+ includeItemInfo)+", includeSetItemRefPaths=")+ includeSetItemRefPaths)+", refPathToSet=")+ refPathToSet)+", additionalProperties=")+ additionalProperties)+"]");
    }
