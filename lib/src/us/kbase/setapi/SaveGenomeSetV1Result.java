...
/**
 * <p>Original spec-file type: SaveGenomeSetV1Result</p>
 * 
 * 
 */
...
public class SaveGenomeSetV1Result {
    ...
    public SaveGenomeSetV1Result withSetRef(java.lang.String setRef) {
        this.setRef = setRef;
        return this;
    }
    ...
    public SaveGenomeSetV1Result withSetInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> setInfo) {
        this.setInfo = setInfo;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((("SaveGenomeSetV1Result"+" [setRef=")+ setRef)+", setInfo=")+ setInfo)+", additionalProperties=")+ additionalProperties)+"]");
    }
