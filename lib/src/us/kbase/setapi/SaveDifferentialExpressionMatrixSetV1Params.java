...
/**
 * <p>Original spec-file type: SaveDifferentialExpressionMatrixSetV1Params</p>
 * <pre>
...
public class SaveDifferentialExpressionMatrixSetV1Params {
    ...
    public SaveDifferentialExpressionMatrixSetV1Params withWorkspace(String workspace) {
        this.workspace = workspace;
        return this;
    }
    ...
    public SaveDifferentialExpressionMatrixSetV1Params withOutputObjectName(String outputObjectName) {
        this.outputObjectName = outputObjectName;
        return this;
    }
    ...
    public SaveDifferentialExpressionMatrixSetV1Params withData(DifferentialExpressionMatrixSet data) {
        this.data = data;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("SaveDifferentialExpressionMatrixSetV1Params"+" [workspace=")+ workspace)+", outputObjectName=")+ outputObjectName)+", data=")+ data)+", additionalProperties=")+ additionalProperties)+"]");
    }
