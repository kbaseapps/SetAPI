...
/**
 * <p>Original spec-file type: CreateRNASeqSampleSetResult</p>
 * 
 * 
 */
...
public class CreateRNASeqSampleSetResult {
    ...
    public CreateRNASeqSampleSetResult withSetRef(java.lang.String setRef) {
        this.setRef = setRef;
        return this;
    }
    ...
    public CreateRNASeqSampleSetResult withSetInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> setInfo) {
        this.setInfo = setInfo;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((("CreateRNASeqSampleSetResult"+" [setRef=")+ setRef)+", setInfo=")+ setInfo)+", additionalProperties=")+ additionalProperties)+"]");
    }
