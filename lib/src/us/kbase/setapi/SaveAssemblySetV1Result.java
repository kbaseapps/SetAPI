...
/**
 * <p>Original spec-file type: SaveAssemblySetV1Result</p>
 * 
 * 
 */
...
public class SaveAssemblySetV1Result {
    ...
    public SaveAssemblySetV1Result withSetRef(java.lang.String setRef) {
        this.setRef = setRef;
        return this;
    }
    ...
    public SaveAssemblySetV1Result withSetInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> setInfo) {
        this.setInfo = setInfo;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((("SaveAssemblySetV1Result"+" [setRef=")+ setRef)+", setInfo=")+ setInfo)+", additionalProperties=")+ additionalProperties)+"]");
    }
