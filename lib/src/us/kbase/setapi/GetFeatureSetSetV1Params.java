...
/**
 * <p>Original spec-file type: GetFeatureSetSetV1Params</p>
 * <pre>
...
public class GetFeatureSetSetV1Params {
    ...
    public GetFeatureSetSetV1Params withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public GetFeatureSetSetV1Params withIncludeItemInfo(Long includeItemInfo) {
        this.includeItemInfo = includeItemInfo;
        return this;
    }
    ...
    public GetFeatureSetSetV1Params withIncludeSetItemRefPaths(Long includeSetItemRefPaths) {
        this.includeSetItemRefPaths = includeSetItemRefPaths;
        return this;
    }
    ...
    public GetFeatureSetSetV1Params withRefPathToSet(List<String> refPathToSet) {
        this.refPathToSet = refPathToSet;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("GetFeatureSetSetV1Params"+" [ref=")+ ref)+", includeItemInfo=")+ includeItemInfo)+", includeSetItemRefPaths=")+ includeSetItemRefPaths)+", refPathToSet=")+ refPathToSet)+", additionalProperties=")+ additionalProperties)+"]");
    }
