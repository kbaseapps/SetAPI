...
public class SaveAssemblySetV1Params {
    ...
    public SaveAssemblySetV1Params withWorkspace(String workspace) {
        this.workspace = workspace;
        return this;
    }
    ...
    public SaveAssemblySetV1Params withOutputObjectName(String outputObjectName) {
        this.outputObjectName = outputObjectName;
        return this;
    }
     ...
     */
    @JsonProperty("data")
    public void setData(AssemblySet data) {
        this.data = data;
    }

    public SaveAssemblySetV1Params withData(AssemblySet data) {
        this.data = data;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("SaveAssemblySetV1Params"+" [workspace=")+ workspace)+", outputObjectName=")+ outputObjectName)+", data=")+ data)+", additionalProperties=")+ additionalProperties)+"]");
    }
