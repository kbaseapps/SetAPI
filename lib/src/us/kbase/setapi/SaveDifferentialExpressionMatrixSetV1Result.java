...
/**
 * <p>Original spec-file type: SaveDifferentialExpressionMatrixSetV1Result</p>
 * 
 * 
 */
...
public class SaveDifferentialExpressionMatrixSetV1Result {
    ...
    public SaveDifferentialExpressionMatrixSetV1Result withSetRef(java.lang.String setRef) {
        this.setRef = setRef;
        return this;
    }
    ...
    public SaveDifferentialExpressionMatrixSetV1Result withSetInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> setInfo) {
        this.setInfo = setInfo;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((("SaveDifferentialExpressionMatrixSetV1Result"+" [setRef=")+ setRef)+", setInfo=")+ setInfo)+", additionalProperties=")+ additionalProperties)+"]");
    }
