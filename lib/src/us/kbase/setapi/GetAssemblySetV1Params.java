...
/**
 * <p>Original spec-file type: GetAssemblySetV1Params</p>
 * <pre>
...
public class GetAssemblySetV1Params {
    ...
    public GetAssemblySetV1Params withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public GetAssemblySetV1Params withIncludeItemInfo(Long includeItemInfo) {
        this.includeItemInfo = includeItemInfo;
        return this;
    }
    ...
    public GetAssemblySetV1Params withIncludeSetItemRefPaths(Long includeSetItemRefPaths) {
        this.includeSetItemRefPaths = includeSetItemRefPaths;
        return this;
    }
    ...
    public GetAssemblySetV1Params withRefPathToSet(List<String> refPathToSet) {
        this.refPathToSet = refPathToSet;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("GetAssemblySetV1Params"+" [ref=")+ ref)+", includeItemInfo=")+ includeItemInfo)+", includeSetItemRefPaths=")+ includeSetItemRefPaths)+", refPathToSet=")+ refPathToSet)+", additionalProperties=")+ additionalProperties)+"]");
    }
