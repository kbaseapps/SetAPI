...
public class ReadsAlignmentSetItem {
    ...
    public ReadsAlignmentSetItem withRefPath(java.lang.String refPath) {
        this.refPath = refPath;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((("ReadsAlignmentSetItem"+" [ref=")+ ref)+", refPath=")+ refPath)+", label=")+ label)+", info=")+ info)+", dataAttachments=")+ dataAttachments)+", additionalProperties=")+ additionalProperties)+"]");
    }
