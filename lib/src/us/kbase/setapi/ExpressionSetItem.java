...
public class ExpressionSetItem {
    ...
    public ExpressionSetItem withRefPath(java.lang.String refPath) {
        this.refPath = refPath;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((("ExpressionSetItem"+" [ref=")+ ref)+", refPath=")+ refPath)+", label=")+ label)+", dataAttachments=")+ dataAttachments)+", info=")+ info)+", additionalProperties=")+ additionalProperties)+"]");
    }
