...
/**
 * <p>Original spec-file type: SaveReadsSetParams</p>
 * <pre>
...
public class SaveReadsSetParams {
    ...
    public SaveReadsSetParams withWorkspaceName(String workspaceName) {
        this.workspaceName = workspaceName;
        return this;
    }
    ...
    public SaveReadsSetParams withWorkspaceId(Long workspaceId) {
        this.workspaceId = workspaceId;
        return this;
    }
    ...
    public SaveReadsSetParams withOutputObjectName(String outputObjectName) {
        this.outputObjectName = outputObjectName;
        return this;
    }
    ...
    public SaveReadsSetParams withOutputRef(String outputRef) {
        this.outputRef = outputRef;
        return this;
    }
    ...
    public SaveReadsSetParams withData(ReadsSet data) {
        this.data = data;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((("SaveReadsSetParams"+" [workspaceName=")+ workspaceName)+", workspaceId=")+ workspaceId)+", outputObjectName=")+ outputObjectName)+", outputRef=")+ outputRef)+", data=")+ data)+", additionalProperties=")+ additionalProperties)+"]");
    }
