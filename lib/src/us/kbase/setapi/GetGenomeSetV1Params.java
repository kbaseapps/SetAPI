...
/**
 * <p>Original spec-file type: GetGenomeSetV1Params</p>
 * <pre>
...
public class GetGenomeSetV1Params {
    ...
    public GetGenomeSetV1Params withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public GetGenomeSetV1Params withIncludeItemInfo(Long includeItemInfo) {
        this.includeItemInfo = includeItemInfo;
        return this;
    }
    ...
    public GetGenomeSetV1Params withIncludeSetItemRefPaths(Long includeSetItemRefPaths) {
        this.includeSetItemRefPaths = includeSetItemRefPaths;
        return this;
    }
    ...
    public GetGenomeSetV1Params withRefPathToSet(List<String> refPathToSet) {
        this.refPathToSet = refPathToSet;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("GetGenomeSetV1Params"+" [ref=")+ ref)+", includeItemInfo=")+ includeItemInfo)+", includeSetItemRefPaths=")+ includeSetItemRefPaths)+", refPathToSet=")+ refPathToSet)+", additionalProperties=")+ additionalProperties)+"]");
    }
