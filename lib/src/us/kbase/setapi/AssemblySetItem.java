...
/**
 * <p>Original spec-file type: AssemblySetItem</p>
 * <pre>
...
public class AssemblySetItem {
    ...
    public AssemblySetItem withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public AssemblySetItem withRefPath(java.lang.String refPath) {
        this.refPath = refPath;
        return this;
    }
    ...
    public AssemblySetItem withLabel(java.lang.String label) {
        this.label = label;
        return this;
    }
    ...
    public AssemblySetItem withInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> info) {
        this.info = info;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("AssemblySetItem"+" [ref=")+ ref)+", refPath=")+ refPath)+", label=")+ label)+", info=")+ info)+", additionalProperties=")+ additionalProperties)+"]");
    }
