...
class SetAPI:
    ...
    GIT_COMMIT_HASH = "82de8b96eaa87de98cbe8b317c335596987260bc"
    ...
    def get_set_v1(self, ctx, params):
        ...
        :param params: instance of type "GetSetV1Params" (Generic
           "get_***_set" or "get_set" request parameters: - ref: workspace
           reference for the set object; can be a KBase UPA (nnnnn/nn/nn) or
           <workspace_name>/<object_name> - include_item_info - 1 or 0; if 1,
           the workspace info (with metadata) for each object in the set is
           included. - include_set_item_ref_paths - 1 or 0; if 1, provides
           ...
           supplied or <set_ref>;<item_ref> if ref_path_to_set is not
           supplied. - ref_path_to_set - optional; the ref path for the set
           object. NOTE: sets can be retrieved using any of the `get_***_set`
           API calls; at present there is no check that the set type returned
           matches the API method used.) -> structure: parameter "ref" of
        ...
        :returns: instance of type "GetGenericSetV1Result" -> structure:
           parameter "data" of type "GenericSet" (Generic data structure for
           sets returned by the SetAPI. Each set is composed of a description
           and an items list that holds the set members. See above for set
           item description.) -> structure: parameter "description" of
           String, parameter "items" of list of type "GenericSetItem"
           (Generic item in a KBase set. At minimum, set members have a ref
           (a KBase identifier - UPA or <workspace_name>/<object_name>) and a
           label. The workspace info and the ref path for the set members can
           be returned by setting the appropriate parameter in the get
           request (see above).) -> structure: parameter "ref" of String,
           parameter "ref_path" of String, parameter "label" of String,
    ...
    def get_differential_expression_matrix_set_v1(self, ctx, params):
        ...
        :returns: instance of type
           ...
           genome. This is not part of the object type, but enforced during
           saving. @meta ws description as description @meta ws length(items)
           as item_count) -> structure: parameter "description" of String,
           parameter "items" of list of type
           "DifferentialExpressionMatrixSetItem" (When saving a
           DifferentialExpressionMatrixSet, only 'ref' is required. You
           should never set 'info'; it is generated by the workspace.
           Retrieve the 'info' for items in the set by setting the input
           parameter 'include_item_info' to 1 in the `get_***_set` query.
           Retrieve the 'ref_path' for items in the set by setting the input
           parameter 'include_set_item_ref_paths' to 1 in the `get_***_set`
           query.) -> structure: parameter "ref" of type
           "ws_diffexpmatrix_id" (The workspace id for a
           DifferentialExpressionMatrix data object. @id ws
           KBaseFeatureValues.DifferentialExpressionMatrix
           KBaseMatrices.DifferentialExpressionMatrix;), parameter "ref_path"
           of type "ws_diffexpmatrix_id" (The workspace id for a
           DifferentialExpressionMatrix data object. @id ws
           KBaseFeatureValues.DifferentialExpressionMatrix
    ...
    def save_differential_expression_matrix_set_v1(self, ctx, params):
        ...
        :returns: instance of type "SaveSetV1Result" (Generic "save_***_set"
           response. Comprises: - set_ref: ref for the newly-created set
           object - set_info: KBase Workspace object info list) -> structure:
    ...
    def get_feature_set_set_v1(self, ctx, params):
        ...
        :returns: instance of type "GetFeatureSetSetV1Result" -> structure:
           ...
           is required. You should never set 'info'; it is generated by the
           workspace. Retrieve the 'info' for items in the set by setting the
           input parameter 'include_item_info' to 1 in the `get_***_set`
           query. Retrieve the 'ref_path' for items in the set by setting the
           input parameter 'include_set_item_ref_paths' to 1 in the
           `get_***_set` query.) -> structure: parameter "ref" of type
           "ws_feature_set_id" (The workspace id for a FeatureSet data
           object. @id ws KBaseCollections.FeatureSet), parameter "ref_path"
           of type "ws_feature_set_id" (The workspace id for a FeatureSet
           data object. @id ws KBaseCollections.FeatureSet), parameter
    ...
    def save_feature_set_set_v1(self, ctx, params):
        ...
        :param params: instance of type "SaveFeatureSetSetV1Params"
           ...
           required. You should never set 'info'; it is generated by the
           workspace. Retrieve the 'info' for items in the set by setting the
           input parameter 'include_item_info' to 1 in the `get_***_set`
           query. Retrieve the 'ref_path' for items in the set by setting the
           input parameter 'include_set_item_ref_paths' to 1 in the
    ...
    def get_expression_set_v1(self, ctx, params):
        ...
        :returns: instance of type "GetExpressionSetV1Result" -> structure:
           ...
           input parameter 'include_set_item_ref_paths' to 1 in the
           `get_***_set` query.) -> structure: parameter "ref" of type
           "ws_expression_id" (The workspace id for a ReadsAlignment data
           object. @id ws KBaseRNASeq.RNASeqExpression), parameter "ref_path"
           of type "ws_expression_id" (The workspace id for a ReadsAlignment
           data object. @id ws KBaseRNASeq.RNASeqExpression), parameter
    ...
    def get_reads_alignment_set_v1(self, ctx, params):
        ...
        :returns: instance of type "GetReadsAlignmentSetV1Result" ->
           ...
           'info'; it is generated by the workspace. Retrieve the 'info' for
           items in the set by setting the input parameter
           'include_item_info' to 1 in the `get_***_set` query. Retrieve the
           'ref_path' for items in the set by setting the input parameter
    ...
    def save_reads_alignment_set_v1(self, ctx, params):
        ...
        :param params: instance of type "SaveReadsAlignmentSetV1Params"
           ...
           'ref' is required. You should never set 'info'; it is generated by
           the workspace. Retrieve the 'info' for items in the set by setting
           the input parameter 'include_item_info' to 1 in the `get_***_set`
           query. Retrieve the 'ref_path' for items in the set by setting the
           input parameter 'include_set_item_ref_paths' to 1 in the
           `get_***_set` query.) -> structure: parameter "ref" of type
           "ws_reads_align_id" (The workspace id for a ReadsAlignment data
           object. @id ws KBaseRNASeq.RNASeqAlignment), parameter "ref_path"
           of type "ws_reads_align_id" (The workspace id for a ReadsAlignment
           data object. @id ws KBaseRNASeq.RNASeqAlignment), parameter
           "label" of String, parameter "info" of type "object_info"
           (Information about an object, including user provided metadata.
           obj_id objid - the numerical id of the object. obj_name name - the
           name of the object. type_string type - the type of the object.
    ...
    def get_reads_set_v1(self, ctx, params):
        ...
        :returns: instance of type "GetReadsSetV1Result" -> structure:
           ...
           "ref_path" of type "ws_reads_id" (The workspace ID for a Reads
           data object. @id ws KBaseFile.PairedEndLibrary
    ...
    def get_assembly_set_v1(self, ctx, params):
        ...
        :returns: instance of type "GetAssemblySetV1Result" -> structure:
           ...
           KBaseGenomeAnnotations.Assembly), parameter "ref_path" of type
           "ws_assembly_id" (The workspace ID for an Assembly object. @id ws
    ...
    def save_assembly_set_v1(self, ctx, params):
        ...
        :param params: instance of type "SaveAssemblySetV1Params"
           ...
           never set 'info'; it is generated by the workspace. Retrieve the
           'info' for items in the set by setting the input parameter
           'include_item_info' to 1 in the `get_***_set` query. Retrieve the
           'ref_path' for items in the set by setting the input parameter
           'include_set_item_ref_paths' to 1 in the `get_***_set` query.) ->
           structure: parameter "ref" of type "ws_assembly_id" (The workspace
           ID for an Assembly object. @id ws
           KBaseGenomeAnnotations.Assembly), parameter "ref_path" of type
           "ws_assembly_id" (The workspace ID for an Assembly object. @id ws
           KBaseGenomeAnnotations.Assembly), parameter "label" of String,
           parameter "info" of type "object_info" (Information about an
    ...
    def get_genome_set_v1(self, ctx, params):
        ...
        :returns: instance of type "GetGenomeSetV1Result" -> structure:
           ...
           KBaseGenomes.Genome), parameter "ref_path" of type "ws_genome_id"
           ...
           GenomeSet, only 'ref' is required. You should never set 'info'; it
           is generated by the workspace. Retrieve the 'info' for items in
           the set by setting the input parameter 'include_item_info' to 1 in
           the `get_***_set` query. Retrieve the 'ref_path' for items in the
           set by setting the input parameter 'include_set_item_ref_paths' to
           1 in the `get_***_set` query.) -> structure: parameter "ref" of
           type "ws_genome_id" (The workspace ID for a Genome object. @id ws
           KBaseGenomes.Genome), parameter "ref_path" of type "ws_genome_id"
           (The workspace ID for a Genome object. @id ws
           KBaseGenomes.Genome), parameter "label" of String, parameter
           "info" of type "object_info" (Information about an object,
    ...
    def create_sample_set(self, ctx, params):
        ...
        :param params: instance of type "CreateRNASeqSampleSetParams"
           (******* Sample SET METHODS ************ Note: SampleSets can be
           retrieved using any of the `get_***_set` API calls; at present
           there is no check that the set type returned matches the API
           method used.) -> structure: parameter "ws_id" of String, parameter
           "sampleset_id" of String, parameter "sampleset_desc" of String,
           parameter "domain" of String, parameter "platform" of String,
           parameter "sample_ids" of list of String, parameter "condition" of
           list of String, parameter "source" of String, parameter
           "Library_type" of String, parameter "publication_id" of String,
           parameter "external_source_date" of String, parameter
           "conditionset_ref" of String, parameter "sample_n_conditions" of
    ...
    def list_sets(self, ctx, params):
        ...
        :param params: instance of type "ListSetParams" (- workspace:
           ...
           metadata in the Set object info and in the object info of the set
           items (it affects DP raw data as well) - include_item_info - 1 or
           0; if 1, the workspace info (with metadata) for each object in the
           set is included. - include_set_item_ref_paths - 1 or 0; if 1,
           provides ref_path for each item in the set. The ref_path returned
           for each item is either <ref_path_to_set>;<item_ref> if
           ref_path_to_set is supplied or <set_ref>;<item_ref> if
           ref_path_to_set is not supplied.) -> structure: parameter
           "workspace" of String, parameter "workspaces" of String, parameter
    ...
    def get_set_items(self, ctx, params):
        ...
        NOTE: DOES NOT PRESERVE ORDERING OF ITEM LIST IN DATA
        :param params: instance of type "GetSetItemsParams" (- set_refs: list
           of SetReferences for Set objects. - include_set_item_ref_paths - 1
           or 0; if 1, provides ref_path for each item in the set. The
           ref_path returned for each item is either
           <ref_path_to_set>;<item_ref> if ref_path_to_set is supplied or
           <set_ref>;<item_ref> if ref_path_to_set is not supplied.) ->
           structure: parameter "set_refs" of list of type "SetReference" ->
           structure: parameter "ref" of type "ws_obj_id" (The workspace ID
           for a any data object. @id ws), parameter "ref_path_to_set" of
           list of type "ws_obj_id" (The workspace ID for a any data object.
           @id ws), parameter "include_set_item_ref_paths" of type "boolean"
