...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'SetAPI'):
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_SetAPI.get_differential_expression_matrix_set_v1,
                             ...
                             types=[dict])
        self.method_authentication['SetAPI.get_differential_expression_matrix_set_v1'] = 'optional'  # noqa
        self.rpc_service.add(impl_SetAPI.save_differential_expression_matrix_set_v1,
                             name='SetAPI.save_differential_expression_matrix_set_v1',
                             types=[dict])
        self.method_authentication['SetAPI.save_differential_expression_matrix_set_v1'] = 'required'  # noqa
        self.rpc_service.add(impl_SetAPI.get_feature_set_set_v1,
                             name='SetAPI.get_feature_set_set_v1',
                             types=[dict])
        self.method_authentication['SetAPI.get_feature_set_set_v1'] = 'optional'  # noqa
        self.rpc_service.add(impl_SetAPI.save_feature_set_set_v1,
        ...
        self.rpc_service.add(impl_SetAPI.sample_set_to_samples_info,
                             name='SetAPI.sample_set_to_samples_info',
                             types=[dict])
        self.method_authentication['SetAPI.sample_set_to_samples_info'] = 'required'  # noqa
